(function(){System.register([`./store-legacy-BiIsTCDz.js`,`./components-legacy-JtbajkDt.js`],function(e,t){var n,r,i,a,o,s,c,l,u,d;return{setters:[function(e){n=e.Gr,r=e.Jn,i=e.Kr,a=e.Q,o=e.Y,s=e.Yr,c=e.p,l=e.ra},function(e){u=e.Y}],execute:function(){d=`<div align="center">\r
\r
...
`,e(`default`,()=>{let e=a();o(`manage.sidemenu.about`);let t=c(`version`)||``;return[l(r,{mb:`$2`,spacing:`$2`,alignItems:`center`,get children(){return[l(n,{colorScheme:`accent`,rounded:`$full`,get children(){return l(i,{children:t||`OpenListNext`})}}),l(s,{color:`$neutral9`,fontSize:`$sm`,get children(){return e(`manage.sidemenu.about`)}})]}}),l(u,{children:d,sanitize:!0})]})}}})})();